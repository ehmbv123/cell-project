# -*- coding: utf-8 -*-
"""
Created on Sat Aug  1 17:51:54 2020
...
if __name__ == '__main__':
    ...
    for f in filelist:
        ...
        img = cv2.imread(f)
        img_list.append(img)
        pathDic, output_img = task1(img, index, pathDic)

        cv2.imwrite('./cell2task1/' + sequence[key] + '/' + str(index) + '.jpg', output_img)

    out_root = "./cell2task1/" + sequence[key] + '/'
    ...
    videoWriter = cv2.VideoWriter(f'./cell2task1{sequence[key]}_task1.avi', cv2.VideoWriter_fourcc('X', 'V', 'I', 'D'), fps, size)
