...
def task1(index,img,pathDic):
    ...
    for i in range(0, len(contours)):
        ...
        if int(np.average(img[y:y+h,x:x+w]))>210.0 and w/h<1.1 and h/w<1.1:
    ...
    img = cv2.putText(img, "division cell number:" + str(divNum), (0, 80), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 69, 0),
                      2)
